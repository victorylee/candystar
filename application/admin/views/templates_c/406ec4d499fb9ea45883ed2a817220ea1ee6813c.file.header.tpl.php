<?php /* Smarty version Smarty-3.1.20, created on 2015-04-22 17:49:58
         compiled from "/mnt/hgfs/website/candystar/application/admin/views/templates/header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2032722721553464936e4722-28352836%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '406ec4d499fb9ea45883ed2a817220ea1ee6813c' => 
    array (
      0 => '/mnt/hgfs/website/candystar/application/admin/views/templates/header.tpl',
      1 => 1429696197,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2032722721553464936e4722-28352836',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.20',
  'unifunc' => 'content_55346493834e47_81504008',
  'variables' => 
  array (
    'emp' => 0,
    'privilegeList' => 0,
...
<?php if ($_valid && !is_callable('content_55346493834e47_81504008')) {function content_55346493834e47_81504008($_smarty_tpl) {?><style type="text/less">
*{
    font-size: 14px;
...
<div id="header">
    <div class="row clearfix">
        ...
        <div class="col user">
            <?php if (isset($_smarty_tpl->tpl_vars['emp']->value)) {?>
                <span id="comname" class="mr10"><?php echo $_smarty_tpl->tpl_vars['emp']->value->name;?>
</span>
...
<script type="text/javascript">
    var privilegeList=<?php if (isset($_smarty_tpl->tpl_vars['privilegeList']->value)) {?><?php echo $_smarty_tpl->tpl_vars['privilegeList']->value;?>
<?php } else { ?>new Array()<?php }?>;
    var cur=<?php if (isset($_smarty_tpl->tpl_vars['module']->value)) {?>'<?php echo $_smarty_tpl->tpl_vars['module']->value;?>
'<?php } else { ?>''<?php }?>;
    var strHtml="";
